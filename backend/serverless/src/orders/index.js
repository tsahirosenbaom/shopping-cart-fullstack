    ...
    try {
        ...
        if (event.httpMethod === 'POST') {
            ...
            if (!body.customer || !body.customer.firstName || !body.customer.lastName || 
                !body.customer.address || !body.customer.email) {
                return {
                    statusCode: 400,
                    headers,
            ...
            const order = {
                ...
                items: body.items,
                totalItems: body.totalItems || body.items.reduce((sum, item) => sum + item.quantity, 0),
            ...
            console.log(`✅ Order created: ${orderId} for ${order.customer.firstName} ${order.customer.lastName}`);
